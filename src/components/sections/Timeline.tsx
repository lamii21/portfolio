...
const EVENTS = [
  {
    year: "2022",
    label: "EMSI — Preparatory Classes",
    title: "Prep years.",
  ...
  {
    year: "2024",
    label: "EMSI — Computer Science & Networks",
  ...
  {
    year: "2025",
    label: "EMSI — DDSI Specialization",
    title: "DDSI begins.",
    body: "Digital Development and Information Systems — software engineering specialization focused on full-stack development, AI integration, and information systems design.",
    tag: "Education",
    accent: false,
  },
  {
  ...
  {
    year: "2025",
    label: "First Internship — Yazaki Morocco",
  ...
  {
    year: "2026",
    label: "Second Internship — YZY DigiTech Technologies",
