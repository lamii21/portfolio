...
const FOCUS_ITEMS = [
  {
    ...
    body: "Actively looking for an AI Software Engineer, Full-Stack Engineer, or Software Engineer role. I respond to every message. What I'm looking for: a team building real AI-integrated products, that debates architecture decisions, and cares how the system is built — not just that it ships.",
    color: "#C97F89",
    primary: true,
  },
  {
    ...
    body: "Five shipped projects with a direct AI/ML component — OCR, symbolic computation, NLP, ML scoring, LSTM forecasting. What I'm extending: LLM integration, vector search, and what deploying a model in production actually requires versus training one in a notebook.",
    color: "#82B4D4",
    primary: false,
  },
  {
