...
const CATEGORIES = [
  ...
  },
  {
    ...
    skills: [
      { name: "Machine Learning",  status: "daily"   },
      { name: "Deep Learning",     status: "daily"   },
      { name: "TensorFlow/Keras",  status: "daily"   },
      { name: "Scikit-learn",      status: "daily"   },
      { name: "NLP / spaCy",       status: "shipped" },
      { name: "LLMs / GenAI",      status: "shipped" },
